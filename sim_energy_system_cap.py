...
def calc_solar_current(irr, sa_m2, eff, voc):
    return irr*sa_m2*eff/voc
...
isc_a = calc_solar_current(irr, sa_m2, eff, voc)
i1_a = isc_a
qt_c = q0_c
p_mode_w = p_on_w
t_s = 0.0
